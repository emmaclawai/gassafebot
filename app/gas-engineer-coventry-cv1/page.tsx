...
export const metadata: Metadata = {
  title: 'Gas Engineer Coventry CV1 | Boiler Service & Gas Safe Engineer | GasSafeBot',
  description: 'Gas Safe registered engineer marketing for Coventry CV1. We help engineers rank for boiler service, CP12 certificates and emergency callout searches across the City Centre, Hillfields and Spon End.',
  keywords: 'gas engineer Coventry CV1, boiler service CV1, gas safe engineer Hillfields Coventry, emergency gas engineer city centre Coventry, CP12 certificate Spon End',
  alternates: { canonical: 'https://www.gassafebot.co.uk/gas-engineer-coventry-cv1/' },
}
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Gas Engineer Coventry CV1', item: 'https://www.gassafebot.co.uk/gas-engineer-coventry-cv1/' },
  ],
}
      ...
      <main style={{ background: '#0d1117', color: '#fff', fontFamily: 'system-ui, sans-serif' }}>
        <section style={{ padding: '5rem 2rem 4rem', maxWidth: '860px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, lineHeight: 1.2, marginBottom: '1.5rem' }}>
            Gas Engineer Coventry CV1<br /><span style={{ color: '#FF6B00' }}>City Centre, Hillfields & Spon End</span>
          </h1>
          <p style={{ fontSize: '1.1rem', color: '#94a3b8', lineHeight: 1.7, maxWidth: '680px', marginBottom: '2rem' }}>
            GasSafeBot helps Gas Safe registered engineers in Coventry CV1 get found on Google. We build websites and local SEO systems that rank for gas engineer searches across City Centre, Hillfields & Spon End and all CV1 postcodes — so your phone rings from local customers, not just word of mouth.
          </p>
        ...
        <section style={{ padding: '3rem 2rem', background: '#111827', borderTop: '1px solid #1e2a1e', borderBottom: '1px solid #1e2a1e' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto' }}>
            ...
            <p style={{ color: '#94a3b8', lineHeight: 1.7, marginBottom: '2rem' }}>CV1 covers central Coventry — a dense urban postcode with a very high proportion of HMOs, student lets, and private rental properties. The University of Warwick and Coventry University create enormous landlord CP12 demand year-round. Hillfields has one of the highest private rental concentrations in the West Midlands. For a gas engineer with a ranked CV1 page, the landlord certificate market alone represents consistent recurring revenue from a single postcode.</p>
        ...
        <div style={{ padding: '1rem 2rem', borderTop: '1px solid #1e2a1e', maxWidth: '860px', margin: '0 auto' }}>
          <nav aria-label="Breadcrumb" style={{ fontSize: '0.82rem', color: '#475569' }}>
            ...
            <span style={{ color: '#94a3b8' }}>Gas Engineer Coventry CV1</span>
          </nav>
        </div>
      </main>
