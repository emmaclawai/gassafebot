...
const areas = [
  { name: "Town Centre", postcode: "LU1" },
  { name: "Bury Park", postcode: "LU1" },
  { name: "Stopsley", postcode: "LU2" },
  { name: "Limbury", postcode: "LU3" },
  { name: "Leagrave", postcode: "LU3" },
  { name: "Farley Hill", postcode: "LU1" },
  { name: "Round Green", postcode: "LU2" },
  { name: "Luton Airport", postcode: "LU2" },
  { name: "Dunstable", postcode: "LU5" },
  { name: "Houghton Regis", postcode: "LU5" },
  { name: "Kempston", postcode: "LU7" },
  { name: "Barton-le-Clay", postcode: "MK45" }
]

const keywords = [
  "gas engineer Luton",
  "boiler service Luton",
  "Gas Safe engineer LU1",
  "boiler installation Luton",
  "emergency gas engineer Luton",
  "heating engineer Bury Park",
  "landlord gas certificate Luton",
  "CP12 certificate Luton",
  "boiler repair LU2",
  "gas engineer Stopsley"
]

const stats = [
  { value: '2,500+', label: 'Monthly searches for gas engineers in Luton' },
  { value: '£0', label: 'Most Luton engineers spend on Google presence' },
  { value: '94%', label: 'Of customers pick from the first Google page' },
  { value: '6–10', label: 'Weeks to rank on page 1 for Luton terms' },
]
...
const packages = [
  {
    ...
    monthly: '+ £197/month',
    featured: false,
    features: ['5-page Luton website', 'Google Business Profile setup', 'Emma AI receptionist', '3 area landing pages', 'Monthly ranking report']
  },
  {
    name: 'Growth',
    setup: '£997',
    monthly: '+ £347/month',
    featured: true,
    features: ['10-page Luton website', 'Full Google Business optimisation', 'Emma AI receptionist', 'All LU1–LU4 area pages', 'Directory citation building', 'Monthly content updates', 'Competitor tracking']
  },
  {
    name: 'Dominator',
    setup: '£1,797',
    monthly: '+ £597/month',
    featured: false,
    features: ['Full Luton area dominance', '20+ area landing pages', 'Emma AI receptionist + calendar', 'Weekly content & SEO', 'Backlink building', 'Priority support']
  },
]
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Luton', item: 'https://gassafebot.co.uk/gas-engineer-marketing/luton/' },
            ],
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Gas Engineer Marketing Luton',
            provider: {
              '@type': 'Organization',
              name: 'GasSafeBot',
            ...
            description: 'SEO, websites and AI receptionists for Gas Safe engineers in Luton'
          })
        }}
      />
      <main>
        <nav aria-label="Breadcrumb" style={{ padding: '1rem 0', fontSize: '0.85rem', color: 'var(--muted)' }}>
          <div className="container">
            ...
            {' '}›{' '}
            <span aria-current="page">Luton</span>
          </div>
        </nav>
        ...
        <section style={{ padding: '5rem 0 4rem', textAlign: 'center' }}>
          <div className="container">
            <div style={{
              ...
              📍 Luton · LU1–LU4 &amp; surrounding
            </div>

            <h1 style={{ fontSize: 'clamp(2.2rem, 5vw, 3.8rem)', lineHeight: 1.1, marginBottom: '1.5rem' }}>
              Gas Engineer Marketing<br /><span style={{ color: 'var(--fire)' }}>Luton</span>
            </h1>

            <p style={{ maxWidth: 680, margin: '0 auto 2.5rem', fontSize: '1.15rem', lineHeight: 1.7, opacity: 0.75 }}>
              Luton has one of the highest proportions of private rental properties of any UK town. Landlords here need CP12 certificates every single year — and when their engineer lets them down or retires, they search Google immediately. A gas engineer who shows up at the top of those searches picks up repeat landlord work that can fill a diary on its own.
            </p>

            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="/#audit" className="btn-primary">Get My Free Luton Audit →</Link>
        ...
        <section style={{ padding: '5rem 0' }}>
          <div className="container">
            <h2 style={{ fontSize: '1.9rem', marginBottom: '1.5rem' }}>The Luton Opportunity</h2>
            <p style={{ lineHeight: 1.8, marginBottom: '1.2rem', opacity: 0.75 }}>The LU postcode area is consistently high-demand for gas engineers. A large HMO sector, proximity to London (making it attractive for property investors), and a dense residential population across Bury Park, Limbury, and Stopsley create constant need for Gas Safe work. Despite this, online competition is surprisingly weak — most top results are directories. A targeted local website can break into the top 3 in this market within two months.</p>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '1.5rem', marginTop: '2rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              {[
                ['Population', '~220,000'],
                ['Key postcodes', 'LU1, LU2, LU3, LU4'],
                ['Competition', 'Low–Medium'],
                ['Peak demand', 'Year-round — massive rental market'],
        ...
        <section style={{ padding: '5rem 0', background: 'rgba(255,255,255,0.02)' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            <h2>Keywords We Target for Luton Engineers</h2>
        ...
        <section style={{ padding: '5rem 0' }} id="how-it-works">
          <div className="container" style={{ textAlign: 'center' }}>
            <h2>How We Rank You in Luton</h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2rem', textAlign: 'left' }}>
              {[
                {
                  num: '01',
                  title: 'Your Luton Website',
                  body: 'Built for the LU1–LU4 postcode area with real local content. Fast on mobile. Every page targets the suburbs and searches your customers actually use.'
                },
                {
                  num: '02',
                  title: 'Local SEO That Sticks',
                  body: 'Google Business Profile optimised for Luton. Directory citations. Area pages for every major suburb. This gets you into the map pack where most enquiries come from.'
                },
                {
                  num: '03',
                  title: 'Emma — Never Miss a Call',
                  body: 'When a customer in Bury Park calls about a CP12 landlord certificate while you\'re on a job, Emma answers, qualifies the work, and books it straight into your calendar.'
                },
              ].map(s => (
        ...
        <section style={{ padding: '5rem 0', background: 'rgba(255,255,255,0.02)' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            <h2>Luton Areas We Build Pages For</h2>
        ...
        <section style={{ padding: '5rem 0' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            <h2>Packages for Luton Engineers</h2>
            <p style={{ maxWidth: 580, margin: '0 auto 3rem', opacity: 0.7, lineHeight: 1.7 }}>All packages include website, local SEO for the LU1–LU4 area, and Emma the AI receptionist.</p>
        ...
        <section style={{ padding: '6rem 0', textAlign: 'center' }}>
          <div className="container">
            <h2>Ready to Own Gas Engineer Search in Luton?</h2>
            <p style={{ maxWidth: 520, margin: '0 auto 2.5rem', opacity: 0.7, lineHeight: 1.7 }}>Get your free Luton audit. We&apos;ll show you where you rank, who&apos;s ahead, and the exact plan to reach page 1.</p>
            <Link href="/#audit" className="btn-primary" style={{ padding: '1.1rem 2.5rem', fontSize: '1.1rem' }}>Get My Free Luton Audit →</Link>
