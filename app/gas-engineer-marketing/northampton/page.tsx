...
const areas = [
  { name: "Town Centre", postcode: "NN1" },
  { name: "Kingsthorpe", postcode: "NN2" },
  { name: "Abington", postcode: "NN3" },
  { name: "Duston", postcode: "NN5" },
  { name: "Weston Favell", postcode: "NN3" },
  { name: "Headlands", postcode: "NN3" },
  { name: "Far Cotton", postcode: "NN4" },
  { name: "Rectory Farm", postcode: "NN3" },
  { name: "Delapre", postcode: "NN4" },
  { name: "Boothville", postcode: "NN3" },
  { name: "Kings Heath", postcode: "NN5" },
  { name: "Sixfields", postcode: "NN5" }
]

const keywords = [
  "gas engineer Northampton",
  "boiler service Northampton",
  "Gas Safe engineer NN1",
  "boiler installation Northampton",
  "emergency gas engineer Northampton",
  "heating engineer Kingsthorpe",
  "landlord gas certificate Northampton",
  "boiler repair NN3",
  "central heating Northampton",
  "gas engineer Duston"
]

const stats = [
  { value: '2,600+', label: 'Monthly searches for gas engineers in Northampton' },
  { value: '£0', label: 'Most Northampton engineers spend on Google presence' },
  { value: '94%', label: 'Of customers pick from the first Google page' },
  { value: '6–10', label: 'Weeks to rank on page 1 for Northampton terms' },
]
...
const packages = [
  {
    ...
    monthly: '+ £197/month',
    featured: false,
    features: ['5-page Northampton website', 'Google Business Profile setup', 'Emma AI receptionist', '3 area landing pages', 'Monthly ranking report']
  },
  {
    name: 'Growth',
    setup: '£997',
    monthly: '+ £347/month',
    featured: true,
    features: ['10-page Northampton website', 'Full Google Business optimisation', 'Emma AI receptionist', 'All NN1–NN5 area pages', 'Directory citation building', 'Monthly content updates', 'Competitor tracking']
  },
  {
    name: 'Dominator',
    setup: '£1,797',
    monthly: '+ £597/month',
    featured: false,
    features: ['Full Northampton area dominance', '20+ area landing pages', 'Emma AI receptionist + calendar', 'Weekly content & SEO', 'Backlink building', 'Priority support']
  },
]
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 3, name: 'Northampton', item: 'https://gassafebot.co.uk/gas-engineer-marketing/northampton/' },
            ],
          }),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            '@context': 'https://schema.org',
            '@type': 'Service',
            name: 'Gas Engineer Marketing Northampton',
            provider: {
              '@type': 'Organization',
              name: 'GasSafeBot',
            ...
            description: 'SEO, websites and AI receptionists for Gas Safe engineers in Northampton'
          })
        }}
      />
      <main>
        <nav aria-label="Breadcrumb" style={{ padding: '1rem 0', fontSize: '0.85rem', color: 'var(--muted)' }}>
          <div className="container">
            ...
            {' '}›{' '}
            <span aria-current="page">Northampton</span>
          </div>
        </nav>
        ...
        <section style={{ padding: '5rem 0 4rem', textAlign: 'center' }}>
          <div className="container">
            <div style={{
              ...
              📍 Northampton · NN1–NN5 &amp; surrounding
            </div>

            <h1 style={{ fontSize: 'clamp(2.2rem, 5vw, 3.8rem)', lineHeight: 1.1, marginBottom: '1.5rem' }}>
              Gas Engineer Marketing<br /><span style={{ color: 'var(--fire)' }}>Northampton</span>
            </h1>

            <p style={{ maxWidth: 680, margin: '0 auto 2.5rem', fontSize: '1.15rem', lineHeight: 1.7, opacity: 0.75 }}>
              Northampton has one of the highest densities of rental properties in the East Midlands — driven by a large student population and proximity to major employers like Barclaycard and Carlsberg. Landlords here need CP12 certificates annually, and they always need them done fast. Engineers who show up on Google get that work.
            </p>

            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="/#audit" className="btn-primary">Get My Free Northampton Audit →</Link>
        ...
        <section style={{ padding: '5rem 0' }}>
          <div className="container">
            <h2 style={{ fontSize: '1.9rem', marginBottom: '1.5rem' }}>The Northampton Opportunity</h2>
            <p style={{ lineHeight: 1.8, marginBottom: '1.2rem', opacity: 0.75 }}>Despite being a city of over 230,000 people, Northampton is underserved by gas engineers with a proper online presence. Most of the engineers working here rely on Checkatrade listings and word of mouth. A dedicated website targeting NN postcodes — with pages for Abington, Kingsthorpe, Duston, and the student areas around the university — can reach page 1 within 6–10 weeks.</p>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, padding: '1.5rem', marginTop: '2rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              {[
                ['Population', '~230,000'],
                ['Key postcodes', 'NN1, NN2, NN3, NN4, NN5'],
                ['Competition', 'Low–Medium'],
                ['Peak demand', 'Oct–Apr + student lettings'],
        ...
        <section style={{ padding: '5rem 0', background: 'rgba(255,255,255,0.02)' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            <h2>Keywords We Target for Northampton Engineers</h2>
        ...
        <section style={{ padding: '5rem 0' }} id="how-it-works">
          <div className="container" style={{ textAlign: 'center' }}>
            <h2>How We Rank You in Northampton</h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2rem', textAlign: 'left' }}>
              {[
                {
                  num: '01',
                  title: 'Your Northampton Website',
                  body: 'Built for the NN1–NN5 postcode area with real local content. Fast on mobile. Every page targets the suburbs and searches your customers actually use.'
                },
                {
                  num: '02',
                  title: 'Local SEO That Sticks',
                  body: 'Google Business Profile optimised for Northampton. Directory citations. Area pages for every major suburb. This gets you into the map pack where most enquiries come from.'
                },
                {
                  num: '03',
                  title: 'Emma — Never Miss a Call',
                  body: 'When a customer in Kingsthorpe calls about a annual boiler service while you\'re on a job, Emma answers, qualifies the work, and books it straight into your calendar.'
                },
              ].map(s => (
        ...
        <section style={{ padding: '5rem 0', background: 'rgba(255,255,255,0.02)' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            <h2>Northampton Areas We Build Pages For</h2>
        ...
        <section style={{ padding: '5rem 0' }}>
          <div className="container" style={{ textAlign: 'center' }}>
            <h2>Packages for Northampton Engineers</h2>
            <p style={{ maxWidth: 580, margin: '0 auto 3rem', opacity: 0.7, lineHeight: 1.7 }}>All packages include website, local SEO for the NN1–NN5 area, and Emma the AI receptionist.</p>
        ...
        <section style={{ padding: '6rem 0', textAlign: 'center' }}>
          <div className="container">
            <h2>Ready to Own Gas Engineer Search in Northampton?</h2>
            <p style={{ maxWidth: 520, margin: '0 auto 2.5rem', opacity: 0.7, lineHeight: 1.7 }}>Get your free Northampton audit. We&apos;ll show you where you rank, who&apos;s ahead, and the exact plan to reach page 1.</p>
            <Link href="/#audit" className="btn-primary" style={{ padding: '1.1rem 2.5rem', fontSize: '1.1rem' }}>Get My Free Northampton Audit →</Link>
