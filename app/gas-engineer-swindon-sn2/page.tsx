...
export const metadata: Metadata = {
  title: 'Gas Engineer Swindon SN2 | Boiler Service & Gas Safe Engineer | GasSafeBot',
  description: 'Gas Safe registered engineer marketing for Swindon SN2. We help engineers rank for boiler service, CP12 certificates and emergency callout searches across Penhill, Moredon and Rodbourne.',
  keywords: 'gas engineer Swindon SN2, boiler service SN2, gas safe engineer Penhill, emergency gas engineer Moredon, CP12 certificate Rodbourne Swindon',
  alternates: { canonical: 'https://www.gassafebot.co.uk/gas-engineer-swindon-sn2/' },
}
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Gas Engineer Swindon SN2', item: 'https://www.gassafebot.co.uk/gas-engineer-swindon-sn2/' },
  ],
}
      ...
      <main style={{ background: '#0d1117', color: '#fff', fontFamily: 'system-ui, sans-serif' }}>
        <section style={{ padding: '5rem 2rem 4rem', maxWidth: '860px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, lineHeight: 1.2, marginBottom: '1.5rem' }}>
            Gas Engineer Swindon SN2<br /><span style={{ color: '#FF6B00' }}>Penhill, Moredon, Rodbourne & Park North</span>
          </h1>
          <p style={{ fontSize: '1.1rem', color: '#94a3b8', lineHeight: 1.7, maxWidth: '680px', marginBottom: '2rem' }}>
            GasSafeBot helps Gas Safe registered engineers in Swindon SN2 get found on Google. We build websites and local SEO systems that rank for gas engineer searches across Penhill, Moredon, Rodbourne & Park North and all SN2 postcodes — so your phone rings from local customers, not just word of mouth.
          </p>
          <Link href="/#contact" style={{ display: 'inline-block', background: '#FF6B00', color: '#fff', padding: '0.85rem 2rem', borderRadius: '8px', textDecoration: 'none', fontWeight: 700, fontSize: '1rem' }}>Get My Free SN2 Audit →</Link>
        </section>
        ...
        <section style={{ padding: '3rem 2rem', background: '#111827', borderTop: '1px solid #1e2a1e', borderBottom: '1px solid #1e2a1e' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto' }}>
            ...
            <p style={{ color: '#94a3b8', lineHeight: 1.7, marginBottom: '2rem' }}>SN2 covers the northern residential areas of Swindon — Penhill, Moredon, and Rodbourne are large council and post-war housing estates with a high proportion of older boilers installed in the 1980s and 90s that are approaching end of life. Boiler replacement and annual servicing demand is strong. Rodbourne has a high private rental concentration, creating consistent CP12 certificate demand year-round.</p>
        ...
        <section style={{ padding: '4rem 2rem', maxWidth: '860px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#94a3b8', lineHeight: 1.7, marginBottom: '1.5rem' }}>
            The majority of gas engineers in Swindon SN2 have no optimised website. Most rely on word of mouth, Checkatrade listings, or a basic Wix page that Google ignores. When a homeowner in Penhill, Moredon, Rodbourne & Park North searches for a gas engineer, the results are dominated by national directories — not local engineers.
          </p>
          <p style={{ color: '#94a3b8', lineHeight: 1.7, marginBottom: '2rem' }}>
            A dedicated page targeting 'Gas Engineer Swindon SN2' is a low-competition ranking opportunity that most engineers are leaving on the table. GasSafeBot builds the pages, writes the content, and handles the technical SEO so you start appearing where your customers are already looking.
          </p>
        ...
        <div style={{ padding: '1rem 2rem', borderTop: '1px solid #1e2a1e', maxWidth: '860px', margin: '0 auto' }}>
          <nav aria-label="Breadcrumb" style={{ fontSize: '0.82rem', color: '#475569' }}>
            ...
            <span style={{ color: '#94a3b8' }}>Gas Engineer Swindon SN2</span>
          </nav>
        </div>
      </main>
