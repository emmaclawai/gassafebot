...
export const metadata: Metadata = {
  title: 'Gas Engineer Coventry CV2 | Boiler Service & Gas Safe Engineer | GasSafeBot',
  description: 'Gas Safe registered engineer marketing for Coventry CV2. We help engineers rank for boiler service, emergency callout and landlord certificates across Stoke Heath, Wyken and Binley.',
  keywords: 'gas engineer Coventry CV2, boiler service CV2, gas safe engineer Wyken Coventry, emergency gas engineer Binley, CP12 certificate Stoke Heath Coventry',
  alternates: { canonical: 'https://www.gassafebot.co.uk/gas-engineer-coventry-cv2/' },
}
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Gas Engineer Coventry CV2', item: 'https://www.gassafebot.co.uk/gas-engineer-coventry-cv2/' },
  ],
}
      ...
      <main style={{ background: '#0d1117', color: '#fff', fontFamily: 'system-ui, sans-serif' }}>
        <section style={{ padding: '5rem 2rem 4rem', maxWidth: '860px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, lineHeight: 1.2, marginBottom: '1.5rem' }}>
            Gas Engineer Coventry CV2<br /><span style={{ color: '#FF6B00' }}>Stoke Heath, Wyken & Binley</span>
          </h1>
          <p style={{ fontSize: '1.1rem', color: '#94a3b8', lineHeight: 1.7, maxWidth: '680px', marginBottom: '2rem' }}>
            GasSafeBot helps Gas Safe registered engineers in Coventry CV2 get found on Google. We build websites and local SEO systems that rank for gas engineer searches across Stoke Heath, Wyken & Binley and all CV2 postcodes — so your phone rings from local customers, not just word of mouth.
          </p>
        ...
        <section style={{ padding: '3rem 2rem', background: '#111827', borderTop: '1px solid #1e2a1e', borderBottom: '1px solid #1e2a1e' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto' }}>
            ...
            <p style={{ color: '#94a3b8', lineHeight: 1.7, marginBottom: '2rem' }}>CV2 covers the eastern residential suburbs of Coventry — Stoke Heath, Wyken, and Binley are large established housing estates with a mix of owner-occupier and privately rented homes. Walsgrave, on the eastern edge of CV2, has seen significant new development around the hospital. Boiler servicing demand in CV2 is strong year-round, and competition from optimised gas engineer websites is minimal — most local engineers here have no web presence beyond a basic directory listing.</p>
        ...
        <div style={{ padding: '1rem 2rem', borderTop: '1px solid #1e2a1e', maxWidth: '860px', margin: '0 auto' }}>
          <nav aria-label="Breadcrumb" style={{ fontSize: '0.82rem', color: '#475569' }}>
            ...
            <span style={{ color: '#94a3b8' }}>Gas Engineer Coventry CV2</span>
          </nav>
        </div>
      </main>
